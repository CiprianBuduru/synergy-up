      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-6">
          {[
            ...
            { icon: Send, label: 'Trimise', value: salesStats.presentations_sent, color: 'from-info/10 to-info/5', iconColor: 'text-info' },
            ...
            { icon: FileText, label: 'Docs trimise', value: salesStats.documents_sent, color: 'from-indigo-500/10 to-indigo-500/5', iconColor: 'text-indigo-600' },
            { icon: Target, label: 'Contracte', value: salesStats.contracts_signed, color: 'from-teal-500/10 to-teal-500/5', iconColor: 'text-teal-600' },
            { icon: Zap, label: 'Clienți activi', value: salesStats.active_clients, color: 'from-accent/10 to-accent/5', iconColor: 'text-accent' },
          ].map((stat, i) => (
              ...
              <Card className="border-0 shadow-sm overflow-hidden">
                ...
                <CardContent className="p-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className={`flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br ${stat.color}`}>
